  ...
  return (
    <>
      ...
      <div className="flex justify-center items-center h-screen">
        <form
          className="bg-[#1B262C]/90 p-10 rounded-3xl shadow-2xl max-w-lg w-full mx-auto flex flex-col space-y-6 border border-[#FBE4CC] mt-10 mb-[150px]"
          onSubmit={handleSubmit}
        >
          <h2 className="text-2xl text-center text-white mb-4">Registration</h2>
          {["name", "email", "password", "age", "field", "price"].map(
            (field) => (
